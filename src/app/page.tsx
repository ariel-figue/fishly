...
export default function Home() {
  const { user, loading } = useAuth(); // Ensure `loading` state is used
  ...
  return (
    <Layout>
      {loading ? ( // ✅ Show Loader when checking user presence
        ...
        <section className="flex flex-col gap-4 items-center">
          ...
          <p className="text-center text-[#34495e] text-base">
            Fishly is an app to keep track of your catches and favorite fishing
            spots
          </p>
